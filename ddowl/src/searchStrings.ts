...
export const CHINESE_TEMPLATES = [
  ...
  `"{NAME}" 谋杀|謀殺|强奸|強姦|抢劫|搶劫|攻击|攻擊|绑架|綁架|盗窃|盜竊|窃取|竊取|被拘|拘留|被捕|收监|收監|监禁|監禁|搶|姦|盜|竊`,

  // Q2: Fraud & Deception (欺诈欺骗)
  `"{NAME}" 诈骗|詐騙|欺诈|詐欺|骗局|騙局|造假|虛假|欺骗|欺騙|受骗|受騙|下套|误导|誤導|诈骗者|詐騙者|欺|騙`,

  // Q3: Financial Crime (金融犯罪)
  `"{NAME}" 洗钱|洗錢|内幕交易|內幕交易|操纵股价|操縱股價|操纵市场|操縱市場|非法集资|非法集資|内线交易|內線交易|崩盘|崩盤|跑路|卷款|捲款|假帐|假帳|操縱|操控|內幕|黑社会|黑社會`,
  ...
  `"{NAME}" 证监会|證監會|廉政公署|廉署|证期局|證期局|处罚|處罰|罚款|罰款|制裁|警告|禁入|禁令|除牌|资产冻结|資產凍結|裁罚|裁罰|处分|處分|懲戒|反貪`,

  // Q6: Legal Proceedings (法律诉讼)
  `"{NAME}" 起诉|起訴|被诉|被訴|判决|判決|审判|審判|开庭|開庭|检察官|檢察官|诉讼|訴訟|投诉|投訴|控告|指控|提审|提審|定罪|有罪|假释|假釋|官司|调查|調查|獄|刑罚|刑罰`,
  ...
  `"{NAME}" 毒贩|毒販|麻药|麻藥|药物成瘾|藥物成癮|滥用药物|濫用藥物|吸毒者|色情|嫖|赌|賭|走私|违禁品|違禁品|恐怖主义|恐怖主義|恐怖分子|极端主义|極端主義`,
...
export const SUPPLEMENTARY_REGISTRY: SupplementaryTemplate[] = [
  ...
  // === Geography-triggered site templates ===
  {
    ...
    template: 'site:economictimes.indiatimes.com OR site:livemint.com OR site:sebi.gov.in OR site:rbi.org.in "{NAME}" enforcement|ED|FEMA|customs|CCI|"competition commission"',
    language: 'en',
    hl: 'en',
  ...
  },
  {
    ...
    template: 'site:samr.gov.cn OR site:12315.cn OR site:miit.gov.cn OR site:csrc.gov.cn "{NAME}"',
    language: 'zh',
    hl: 'zh-cn',
  ...
  },
  {
    ...
    template: 'site:ftc.gov OR site:cfpb.gov OR site:epa.gov OR site:cftc.gov "{NAME}"',
    language: 'en',
    hl: 'en',
  ...
  },
  {
    ...
    template: 'site:ftc.gov.tw OR site:tipo.gov.tw OR site:judicial.gov.tw "{NAME}"',
    language: 'zh',
    hl: 'zh-tw',
  ...
  {
    id: 'GEO_HK',
    category: 'Hong Kong Regulatory',
    template: 'site:hkma.gov.hk OR site:icac.org.hk OR site:pcpd.org.hk "{NAME}"',
    language: 'en',
    hl: 'en',
    triggers: { geographies: ['hong kong', 'hk'] },
  },
  {
    id: 'GEO_SG',
    category: 'Singapore Regulatory',
    template: 'site:mas.gov.sg OR site:acra.gov.sg OR site:sgx.com "{NAME}"',
    language: 'en',
    hl: 'en',
    triggers: { geographies: ['singapore', 'sg'] },
  },
  {
    id: 'GEO_UK',
    category: 'UK Regulatory',
    template: 'site:fca.org.uk OR site:sfo.gov.uk OR site:judiciary.uk "{NAME}"',
    language: 'en',
    hl: 'en',
    triggers: { geographies: ['uk', 'united kingdom', 'britain', 'london'] },
  },
  {
    id: 'GEO_JP',
    category: 'Japan Regulatory',
    template: 'site:fsa.go.jp OR site:jftc.go.jp "{NAME}"',
    language: 'en',
    hl: 'en',
    triggers: { geographies: ['japan', 'tokyo'] },
  },
  {
    id: 'GEO_KR',
    category: 'Korea Regulatory',
    template: 'site:fss.or.kr OR site:ftc.go.kr "{NAME}"',
    language: 'en',
    hl: 'en',
    triggers: { geographies: ['korea', 'seoul'] },
  },
  {
    id: 'GEO_AU',
    category: 'Australia Regulatory',
    template: 'site:asic.gov.au OR site:accc.gov.au "{NAME}"',
    language: 'en',
    hl: 'en',
    triggers: { geographies: ['australia', 'sydney', 'melbourne'] },
  },
  {
    id: 'GEO_MY',
    category: 'Malaysia Regulatory',
    template: 'site:sc.com.my OR site:bnm.gov.my "{NAME}"',
    language: 'en',
    hl: 'en',
    triggers: { geographies: ['malaysia', 'kuala lumpur'] },
  },
  {
    id: 'GEO_CN_COURT',
    category: 'China Court & Anti-Corruption',
    template: 'site:ccdi.gov.cn OR site:12309.gov.cn OR site:szse.cn "{NAME}"',
    language: 'zh',
    hl: 'zh-cn',
    triggers: { geographies: ['china', 'chinese', 'mainland', 'prc', 'beijing', 'shanghai', 'shenzhen', 'guangzhou', 'chengdu'] },
  },
  {
    id: 'COMP_OFFSHORE',
    category: 'Offshore Leaks',
    template: 'site:offshoreleaks.icij.org "{NAME}"',
    language: 'en',
    hl: 'en',
    triggers: { entityType: 'company', always: true },
  },
...
export function inferGeographyFromName(name: string): string[] {
  ...
  const geo: [RegExp, string][] = [
    ...
    [/hong kong|hk\b/i, 'hong kong'],
    [/singapore/i, 'singapore'],
    [/uk\b|united kingdom|britain|london/i, 'uk'],
    [/japan|tokyo/i, 'japan'],
    [/korea|seoul/i, 'korea'],
    [/australia|sydney|melbourne/i, 'australia'],
    [/malaysia|kuala lumpur/i, 'malaysia'],
  ];
